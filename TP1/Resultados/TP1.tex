...
\begin{document}
	...
	\begin{itemize}
		...
		\item Las reglas generadas e identificadas como interesantes reflejan un periodo de comparación similar entre un año y otro, a las elegidas del 2014 se les calcularon a "mano" las medidas en el 2015 para ver el impacto de la mismas en ese año.
	\end{itemize}
	
	Como se mencionó en los apartados anteriores para la selección de las reglas se usó la medida Kulczynsky, la cual en ambas tablas tiene valores altos y en el caso de algunas reglas con valor de 0.50 se utilizó la razón de desbalanceo (IR) para ayudar en la decisión.\\
	
	En el resultado encontrado de las reglas \textit{\textbf{por ID de producto}}, "Copo Modelo: LN129B Tipo: EXTENSIBLE" resultó en una compra por parte de clientes muy frecuentes junto al "Copo Modelo: LN117B Tipo: ALUM.ANODIZADO" durante el 2014 sin embargo en el 2015 para el mismo periodo no tuvo un impacto significativo es decir no fue una compra frecuente.\\
	
	Por otro lado la compra de Binoculares Teens en 2 colores diferentes (Rojo y Negro) por parte de clientes poco frecuente y casas de óptica, en el 2015 tampoco tuvo impacto significativo al ver que el porcentaje de transacciones en el que se encuentra es practicamente cero.\\
	
	Con respecto a las reglas asociadas con la \textit{\textbf{descripción del producto}}, se puede apreciar una bastante interesante que es la compra de 2 tipos de pala: plegable y pala pico por parte de clientes muy frecuentes en el 2014 tiene un impacto similar en el 2015.\\
	
	De la misma manera, las líneas monofilamento en cojunto con los reels tipo charger por clientes poco frecuentes junto con el reel Bellus, esto en el 2015 se ve que es una regla interesante con una asociación negativa, es decir que un cliente que compre un reel tipo charger con una linea monofilamento es poco probable que compre un reel Bellus.\\
	
	Para las reglas de \textbf{\textit{subcategoría}} se destacan las referentes a las cañas de tipo Pejerrey y sus correspondiente accesorio del mismo tipo (reel) junto con anzuelos y clientes con un gasto medio solamente en el 2014 pero no aportan lo mismo en el 2015.\\ 
	
	Las bolsas de dormir rectangulares con las de tipo sarcofago se asocian con la compra de linternas por casas de pesca, esta regla en el 2014 tienen una asociación positiva mientras que en el 2015 no resulto interesante.\\\\ 
